...
*   by Kris Randall 2014
* ---
* Based on Placeholder plugin for jQuery, Copyright 2010, Daniel Stocks (http://webcloud.se)
...
// auto-init for textarea's
jQuery(document).ready(function() {
    $('textarea.placeholder').css('color', 'grey');
